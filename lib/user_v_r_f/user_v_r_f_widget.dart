...
class UserVRFWidget extends StatefulWidget {
  const UserVRFWidget({Key? key}) : super(key: key);

  @override
  _UserVRFWidgetState createState() => _UserVRFWidgetState();
}

class _UserVRFWidgetState extends State<UserVRFWidget> {
