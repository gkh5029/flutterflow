...
class KycPage2rejWidget extends StatefulWidget {
  const KycPage2rejWidget({Key? key}) : super(key: key);

  @override
  _KycPage2rejWidgetState createState() => _KycPage2rejWidgetState();
}

class _KycPage2rejWidgetState extends State<KycPage2rejWidget> {
                          ...
                          children: [
                            Padding(
                              ...
                              child: PageView(
                                ...
                                children: [
                                  Image.network(
                                    pageViewEkycRecord!.passport!,
                                    width: 100,
                                    height: 130,
                                    fit: BoxFit.cover,
                                  ),
                                  Image.network(
                                    pageViewEkycRecord!.arcA!,
                                    width: 100,
                                    height: 100,
                                    fit: BoxFit.cover,
                                  ),
                                  Image.network(
                                    pageViewEkycRecord!.arcB!,
                                    width: 100,
                                    height: 100,
                                    fit: BoxFit.cover,
                                  ),
